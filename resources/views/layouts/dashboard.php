...
.theme-slate input[type="text"], .theme-slate input[type="password"], .theme-slate input[type="email"], .theme-slate input[type="url"], .theme-slate input[type="tel"], .theme-slate input[type="number"], .theme-slate input[type="date"], .theme-slate input[type="time"], .theme-slate input[type="search"], .theme-slate select, .theme-slate textarea { background-color: #0b1220 !important; color: #e2e8f0 !important; border: 1px solid #334155 !important; border-radius: 0.5rem; padding: 0.5rem 0.75rem !important; line-height: 1.5rem !important; min-height: 2.75rem; }
.theme-slate input::placeholder, .theme-slate textarea::placeholder { color: #64748b !important; }
.theme-slate input:focus, .theme-slate select:focus, .theme-slate textarea:focus { outline: none !important; border-color: #06b6d4 !important; box-shadow: 0 0 0 3px rgba(6, 182, 212, 0.25) !important; }
