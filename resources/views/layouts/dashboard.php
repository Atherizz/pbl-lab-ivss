...
<style>
    ...
    .theme-slate .bg-gray-50,
    .theme-slate .bg-gray-100 {
        background-color: #0f172a !important;
    }

    .theme-slate .bg-white {
        background-color: #1f2937 !important;
    }

    .theme-slate .text-gray-900,
    .theme-slate .text-gray-800 {
        color: #e2e8f0 !important;
    }

    .theme-slate .text-gray-700 {
        color: #cbd5e1 !important;
    }

    .theme-slate .text-gray-600 {
        color: #a3b2c5 !important;
    }

    .theme-slate .text-gray-500,
    .theme-slate .text-gray-400 {
        color: #94a3b8 !important;
    }

    .theme-slate .border-gray-100,
    .theme-slate .border-gray-200 {
        border-color: #334155 !important;
    }

    .theme-slate .hover\:bg-gray-50:hover {
        background-color: #111827 !important;
    }

    .theme-slate .bg-blue-50 {
        background-color: rgba(8, 145, 178, 0.12) !important;
    }

    .theme-slate .text-blue-700 {
        color: #22d3ee !important;
    }

    .theme-slate .bg-purple-50 {
        background-color: rgba(168, 85, 247, 0.12) !important;
    }

    .theme-slate .text-purple-700 {
        color: #c084fc !important;
    }

    .theme-slate .bg-orange-50 {
        background-color: rgba(251, 146, 60, 0.12) !important;
    }

    .theme-slate .text-orange-700 {
        color: #fb923c !important;
    }

    .theme-slate .text-red-600 {
        color: #f87171 !important;
    }

    .theme-slate .hover\:bg-red-50:hover {
        background-color: rgba(248, 113, 113, 0.12) !important;
    }

    /* Form focus accents to cyan */
    .theme-slate .focus\:ring-blue-500:focus {
        --tw-ring-color: #06b6d4 !important;
    }

    .theme-slate .focus\:border-blue-500:focus {
        border-color: #06b6d4 !important;
    }

    /* Badges */
    .theme-slate .bg-green-50 {
        background-color: rgba(34, 197, 94, 0.12) !important;
    }

    .theme-slate .text-green-600 {
        color: #34d399 !important;
    }

    .theme-slate .bg-red-100 {
        background-color: rgba(248, 113, 113, 0.18) !important;
    }

    .theme-slate .text-red-700 {
        color: #ef4444 !important;
    }

    .theme-slate .bg-green-100 {
        background-color: rgba(34, 197, 94, 0.18) !important;
    }

    .theme-slate .text-green-700 {
    ...
    .theme-slate textarea::placeholder {
    ...
    .theme-slate .bg-blue-600 {
        background-color: #0891b2 !important;
    }

    .theme-slate .bg-blue-700 {
        background-color: #0e7490 !important;
    }

    .theme-slate .bg-blue-500 {
        background-color: #06b6d4 !important;
    }

    .theme-slate .hover\:bg-blue-600:hover {
        background-color: #0891b2 !important;
    }

    .theme-slate .hover\:bg-blue-700:hover {
        background-color: #0e7490 !important;
    }

    .theme-slate .text-blue-600 {
        color: #22d3ee !important;
    }
    ...
    .theme-slate .hover\:text-blue-700:hover {
        color: #2dd4bf !important;
    }

    .theme-slate .border-blue-500 {
        border-color: #06b6d4 !important;
    }

    .theme-slate .ring-blue-500 {
        --tw-ring-color: #06b6d4 !important;
    }
</style>
