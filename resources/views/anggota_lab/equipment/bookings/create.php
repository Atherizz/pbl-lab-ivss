<?php
$pageTitle = 'Form Peminjaman Peralatan';
$activeMenu = 'bookings';
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-700 mb-6">Detail Peminjaman: </h2>
                ...
                <form action="<?= BASE_URL ?? '.' ?>/anggota-lab/equipment/bookings" method="POST">
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-100 p-4 rounded-md border border-gray-300">
                            <p class="text-sm font-medium text-gray-700">Peralatan yang dipinjam:</p>
