<?php 
$pageTitle = 'Tambah Peralatan Baru';
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-700 mb-6">Detail Peralatan</h2>

                <form action="<?= BASE_URL ?? '.' ?>/admin-lab/equipment" method="POST">
                    <div class="space-y-6">
                        <div>
