                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                required
                                class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <?php $currentCategory = $equipment['category'] ?? 'equipment'; ?>
                                <option value="equipment" <?= $currentCategory === 'equipment' ? 'selected' : '' ?>>Peralatan</option>
                                <option value="facility"  <?= $currentCategory === 'facility'  ? 'selected' : '' ?>>Fasilitas</option>
                            </select>
                        </div>
