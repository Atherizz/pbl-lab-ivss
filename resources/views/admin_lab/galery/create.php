<?php 
$pageTitle = 'Buat Dokumentasi Kegiatan';
$activeMenu = 'galery'; // Sesuaikan menu aktif jika ada

// Data lama disesuaikan untuk Galeri: hanya caption dan file gambar
$old_data = $old_data ?? ['caption' => '', 'image_file' => ''];
?>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-700 mb-6">Detail Galeri</h2>
                ...
                <form action="<?= BASE_URL ?? '.' ?>/admin-lab/galery/store" method="POST" enctype="multipart/form-data">
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="caption" name="caption" rows="4" required
                                    class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 px-3 py-2"><?= htmlspecialchars($old_data['caption'] ?? '') ?></textarea>
                        </div>

                        <div>
                            <label for="image_file_input" class="block text-sm font-medium text-gray-700">
                                Gambar Dokumentasi <span class="text-red-500">*</span>
                            </label>
