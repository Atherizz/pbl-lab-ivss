  ...
  <section id="produk" class="py-20 bg-slate-800 border-t border-slate-700 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 relative z-10">
      ...
      <div class="text-center mb-16 animate-fade-in-up">
        ...
        <h2 class="text-3xl md:text-4xl font-bold text-white mt-2">Produk & <span class="text-blue-500">Inovasi</span>
        </h2>
        <p class="text-slate-400 max-w-2xl mx-auto mt-2">Solusi teknologi tepat guna hasil pengembangan riset
          laboratorium IVSS.</p>
      </div>
      ...
      <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div
          class="group bg-slate-900 rounded-2xl border border-slate-700 overflow-hidden hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10 animate-fade-in-up delay-100">
          <div class="relative h-56 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1535591273668-578e31182c4f?q=80&w=800" alt="Smart Aqua"
          ...
          <div class="p-8">
            <h3 class="text-2xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors">Sistem Monitoring
              Kualitas Air Kolam Lele</h3>
            <p class="text-slate-400 text-sm mb-4 leading-relaxed">
              Solusi berbasis IoT untuk memantau pH, suhu, dan kekeruhan air secara <i>real-time</i> guna meningkatkan
              produktivitas panen lele.
            </p>
            <ul class="text-sm text-slate-500 space-y-2 mb-6">
              <li class="flex items-center gap-2"><i class="fas fa-check text-cyan-500"></i> Real-time Monitoring via
                Android</li>
              <li class="flex items-center gap-2"><i class="fas fa-check text-cyan-500"></i> Notifikasi Kualitas Air
              </li>
            </ul>
            <button
              class="w-full py-3 border border-slate-600 text-slate-300 rounded-xl hover:bg-cyan-600 hover:text-white hover:border-cyan-600 transition-all text-sm font-bold">
              Lihat Detail Produk
            </button>
          </div>
        </div>
        ...
        <div
          class="group bg-slate-900 rounded-2xl border border-slate-700 overflow-hidden hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10 animate-fade-in-up delay-200">
          <div class="relative h-56 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1555952494-efd681c7e3f9?q=80&w=800" alt="Face Guard"
              class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            <div
              class="absolute top-3 right-3 bg-purple-600 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
              AI Vision</div>
          </div>
          <div class="p-8">
            <h3 class="text-2xl font-bold text-white mb-2 group-hover:text-purple-400 transition-colors">FaceGuard
              Access</h3>
            <p class="text-slate-400 text-sm mb-4 leading-relaxed">
              Perangkat kontrol akses pintu pintar menggunakan pengenalan wajah (Face Recognition) dengan fitur keamanan
              anti-spoofing.
            </p>
            <ul class="text-sm text-slate-500 space-y-2 mb-6">
              <li class="flex items-center gap-2"><i class="fas fa-check text-purple-500"></i> Liveness Detection</li>
              <li class="flex items-center gap-2"><i class="fas fa-check text-purple-500"></i> Log Kehadiran Otomatis
              </li>
            </ul>
            <button
              class="w-full py-3 border border-slate-600 text-slate-300 rounded-xl hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all text-sm font-bold">
              Lihat Detail Produk
            </button>
          </div>
        </div>
